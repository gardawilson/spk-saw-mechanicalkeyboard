                ...
                <div class="modal-content">
                    ...
                    <form action="matrik-simpan.php" method="POST">
                        <div class="modal-body">
                            ...
                            <?php
$sql = 'SELECT id_alternative,name FROM saw_alternatives WHERE value_p IS NULL OR value_p=0';
$result = $db->query($sql); 
$i = 0;
while ($row = $result->fetch_object()) {
...
-->
                            ...
                            <select name="value[]" class="form-control" required>
                                <option value=1>Rp. 0 - 499.999</option>
                                <option value=2>Rp. 500.000 - 749.999</option>
                                <option value=3>Rp. 750.000 - 999.999</option>
                                <option value=4>Rp. 1.000.000 - 1.249.999</option>
                                <option value=5>>= Rp. 1.250.000</option>
                            </select>
                            <p>Switch</p>
                            <select name="value[]" class="form-control" required>
                                <option value=1>No Switch</option>
                                <option value=2>Cherry MX</option>
                                <option value=3>Outemu</option>
                                <option value=4>Gateron</option>
                                <option value=5>Kalih</option>
                            </select>
                            <p>Layout</p>
                            <select name="value[]" class="form-control" required>
                                ...
                                <option value=4>TKL (80%)</option>
                                <option value=5>Fullsize (100%)</option>
                            </select>
                            <p>Konektivitas</p>
                            <select name="value[]" class="form-control" required>
                                <option value=1>Wired</option>
                                <option value=2>Bluetooth</option>
                                <option value=3>Wired, Bluetooth</option>
                                <option value=4>Wired, Dongle</option>
                                <option value=5>Wired, Bluetooth, Dongle</option>
                            </select>
                            <p>Model PCB</p>
                            <select name="value[]" class="form-control" required>
                                <option value=1>Removable</option>
                                <option value=5>Hotswap</option>
                            </select>
                            </div>
